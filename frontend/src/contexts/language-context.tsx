...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'project.noEndpointsTitle': 'No Endpoints',
    'project.noEndpointsWithSwagger': 'Click "Sync APIs" to import endpoints from Swagger, or add endpoints manually.',
    'project.noEndpointsWithoutSwagger': 'Add endpoints manually to start monitoring your APIs. You can also configure a Swagger URL in project settings.',
    'project.method': 'Method',
    'project.path': 'Path',
    'project.summary': 'Summary',
    'project.summaryPlaceholder': 'Brief description of this endpoint',
    'project.expectedStatus': 'Expected Status Code',
    'project.advancedOptions': 'Advanced Options',
    'project.headers': 'Headers',
    'project.headersPlaceholder': '{"Authorization": "Bearer token", "Content-Type": "application/json"}',
    'project.queryParams': 'Query Parameters',
    'project.queryParamsPlaceholder': '{"page": "1", "limit": "10"}',
    'project.requestBody': 'Request Body',
    'project.requestBodyPlaceholder': '{"name": "example", "value": 123}',
    'project.pathParams': 'Path Parameters',
    'project.testEndpoint': 'Test Endpoint',
    'project.runTest': 'Run Test',
    'project.noPathParams': 'No path parameters required',
    'project.noQueryParams': 'No query parameters defined',
    'project.schemaAvailable': 'Schema data is auto-populated from Swagger. Modify as needed.',
    'project.fileUploadEndpoint': 'This endpoint accepts file uploads ({contentType}). File upload testing is not supported in this interface.',
    'project.noRequestBody': 'This endpoint does not require a request body.',
    'project.authorize': 'Authorize',
    'project.authorizeDesc': 'Set authentication for all API requests in this project',
    'project.authConfigured': 'Auth configured',
    'project.noAuth': 'No authentication',
    'project.clearAuth': 'Clear',
    ...
    'project.swaggerUrlRequired': 'Please enter at least one Swagger URL',
    'project.configureSwagger': 'Configure Swagger URL',
    'project.configureSwaggerDesc': 'Enter your OpenAPI/Swagger URL to automatically import API endpoints.',
    'project.saveAndSync': 'Save & Sync',
  ...
  ko: {
    ...
    'project.noEndpointsTitle': '엔드포인트가 없습니다',
    'project.noEndpointsWithSwagger': '"API 동기화"를 클릭하여 Swagger에서 가져오거나 수동으로 엔드포인트를 추가하세요.',
    'project.noEndpointsWithoutSwagger': '수동으로 엔드포인트를 추가하여 API 모니터링을 시작하세요. 프로젝트 설정에서 Swagger URL을 구성할 수도 있습니다.',
    'project.method': '메소드',
    'project.path': '경로',
    'project.summary': '요약',
    'project.summaryPlaceholder': '이 엔드포인트에 대한 간단한 설명',
    'project.expectedStatus': '예상 상태 코드',
    'project.advancedOptions': '고급 옵션',
    'project.headers': '헤더',
    'project.headersPlaceholder': '{"Authorization": "Bearer token", "Content-Type": "application/json"}',
    'project.queryParams': '쿼리 파라미터',
    'project.queryParamsPlaceholder': '{"page": "1", "limit": "10"}',
    'project.requestBody': '요청 본문',
    'project.requestBodyPlaceholder': '{"name": "example", "value": 123}',
    'project.pathParams': '경로 파라미터',
    'project.testEndpoint': '엔드포인트 테스트',
    'project.runTest': '테스트 실행',
    'project.noPathParams': '경로 파라미터 없음',
    'project.noQueryParams': '쿼리 파라미터 없음',
    'project.schemaAvailable': 'Swagger에서 스키마 데이터가 자동으로 채워졌습니다. 필요에 따라 수정하세요.',
    'project.fileUploadEndpoint': '이 엔드포인트는 파일 업로드를 위한 것입니다 ({contentType}). 파일 업로드 테스트는 이 인터페이스에서 지원되지 않습니다.',
    'project.noRequestBody': '이 엔드포인트는 요청 본문이 필요하지 않습니다.',
    'project.authorize': '인증 설정',
    'project.authorizeDesc': '이 프로젝트의 모든 API 요청에 적용될 인증을 설정합니다',
    'project.authConfigured': '인증 설정됨',
    'project.noAuth': '인증 없음',
    'project.clearAuth': '초기화',
    ...
    'project.swaggerUrlRequired': 'Swagger URL을 하나 이상 입력해주세요',
    'project.configureSwagger': 'Swagger URL 설정',
    'project.configureSwaggerDesc': 'OpenAPI/Swagger URL을 입력하여 API 엔드포인트를 자동으로 가져옵니다.',
    'project.saveAndSync': '저장 및 동기화',
